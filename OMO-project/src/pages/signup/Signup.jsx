...
<div className={styles["signup-inner-container"]}>
        <div className={styles["signup-email-container"]}>
          <label className={styles["signup-email"]} for="signup-email">이메일</label>
          <input className={styles["signup-email-input"]} type="text" id="signup-email" placeholder="아이디를 입력해주세요." />
        ...
        <div className={styles["signup-pw-container"]}>
          <label className={styles["signup-pw"]} for="signup-pw">비밀번호</label>
        ...
        <div className={styles["signup-pw-check-container"]}>
          <label className={styles["signup-pw-check"]} for="signup-pw-check">비밀번호 확인</label>
        ...
        <div className={styles["signup-birth-date-container"]}>
          <label className={styles["signup-birth-date"]} for="birth-date">생년월일</label>
          <input className={styles["signup-birth-date-input"]}  type="date" id="birth-date" />
        </div>

        <div className={styles["signup-nickname-container"]}>
          <label className={styles["signup-nickname"]} for="nickname">닉네임</label>
        ...
        <div className={styles["signup-mbti-container"]}>
          <label  className={styles["signup-mbti"]} for="mbti">MBTI</label>
        ...
        <div>
        <label className={styles["gender"]} for="gender">성별</label>
