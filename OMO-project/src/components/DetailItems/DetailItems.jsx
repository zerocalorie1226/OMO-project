...
export const DetailItems = (props) => (
  <>
    ...
    <div className={styles["detail-thumbnail-container"]}><img src={props.img1} alt="썸네일 이미지" style={{width: "460px", height: "460px"}}/></div>
    <span className={styles["detail-title"]}>{props.title}</span>
    <div  className={styles["detail-like-jjim-container"]}>
    <div className={styles["detail-like"]}> <img src={Like} alt="좋아요 아이콘" style={{width: "24px", height: "24px"}}/> <span className={styles["detail-like-number"]}> {props.like}</span></div>
    ...
    <section className={styles["detail-sales-info-container"]}>
      <div  className={styles["detail-sales-info-inner-container"]} >
        <img src={SalesInfo} alt="영업정보 아이콘" /><span className={styles["detail-sales-info-title"]}>영업정보</span></div>
    ...
    <section className={styles["detail-google-map-container"]}>
      <div  className={styles["detail-google-map-inner-container"]} >
        <img src={props.googleMap} alt="구글맵 이미지" style={{width: "1000px",display:"flex", alignItems:"center"}} />
      </div>
    </section>
