...
export const Review = ({id, writer, createdDate, imageName, content, fetchImgFile}) => 
  {
    ...
    <>
      <div className={styles["detail-review-box"]}>
        <div className={styles["detail-review-inner-top-container"]}>
          ...
          {imageName && <img src={fetchImgFile} alt="리뷰 이미지" className={styles["detail-review-image"]} />} {/* 이미지가 있을 때만 이미지 표시 */}
